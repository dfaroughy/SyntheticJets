...
N = 100000
tag = 'small_model'
signal_id = "c503ea30d038404db48f793209342d44"
background_id = "059cdd20942f46ca954c1cd1f7af9702"
...
sig_gpt2.top_k = sig_gpt2.start_token
...
bkg_gpt2 = JetGPT2Model.load_from_checkpoint(f"{path}/{background_id}/checkpoints/best.ckpt")
prompts = torch.full((N, 1), bkg_gpt2.start_token, dtype=torch.long, device=bkg_gpt2.device)
prompt_dataloadeer = DataLoader(prompts, batch_size=1024, shuffle=False)

bkg_gpt2.top_k = bkg_gpt2.start_token
